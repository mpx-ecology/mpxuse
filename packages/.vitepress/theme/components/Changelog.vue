...
import type { CommitInfo } from '../../../../packages/metadata/scripts/metadata'
import { functions } from '../../../../packages/metadata/scripts/metadata'
  ...
  <div class="grid grid-cols-[30px_auto] -ml-1 gap-1.5 children:my-auto">
    <template v-for="(commit, idx) of commits" :key="commit.hash">
      ...
      <template v-if="commit.version">
        ...
        <div>
          <a
            :href="`https://github.com/mpx-ecology/mpxuse/releases/tag/${commit.version}`"
            target="_blank"
          >
      ...
      <template v-else>
        ...
        <div>
          <a :href="`https://github.com/mpx-ecology/mpxuse/commit/${commit.hash}`" target="_blank">
